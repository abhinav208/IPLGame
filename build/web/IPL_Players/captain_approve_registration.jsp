<%-- 
    Document   : captain_approve_registration
    Created on : 27 Aug, 2020, 11:10:07 PM
...
<html>
    ...
    <body style="margin-top: 0px; background-image: url(../Images/bg.jpg); overflow-y: scroll;">
        <%
            UserBean authUser = (UserBean) session.getAttribute("cap654Object");
            if (authUser == null) {
                response.sendRedirect("../logout.jsp");
                authUser = (UserBean) session.getAttribute("userObject");
            }
        %>
        ...
        <%
            ...
            String user_team;
            String login_user_team = authUser.getUserTeam();
            UserBean UserDetails = new UserBean();
            UserLogic userLogic = new UserLogic();
        %>
        <br/><br/>
        <div><form action="../Admin/updateUserStatus" method="Post">
                <input type="hidden" name="originPage" value="../IPL_Players/captain_approve_registration.jsp">
                <center>
                ...
                <br/><br/>
                <table border="1" cellpadding="3" cellspacing="0" style="width: 1200px;" align="center" id="bidTable">
                    ...
                    <%
                        ...
                        while (itr.hasNext()) {
                            ...
                            System.out.println(login_user_team);
                            if (userStatus.equals("APPLIED") && login_user_team.equals(user_team)) {
                    %>
