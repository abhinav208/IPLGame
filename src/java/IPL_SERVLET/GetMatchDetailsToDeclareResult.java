 ...
 */
public class GetMatchDetailsToDeclareResult extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<MatchBean> matchList = matchLogic.getClosedMatchDetails();
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("ajx_declare_match_result_details.jsp");
